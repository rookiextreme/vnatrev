...
import 'package:vnatpro2/app/views/auth/models/authModel.dart';
import 'package:vnatpro2/app/views/auth/widget/authCarouselWidget.dart';
...
Widget themeLogo() {
  return Row(
    ...
    children: <Widget>[
      Image.asset('images/login/vnat.png', width: 30, height: 30),
      text("VNAT", fontSize: textSizeLarge, fontFamily: fontBold, textColor: appStore.textPrimaryColor).paddingLeft(spacing_standard_new)
    ],
  );
}
