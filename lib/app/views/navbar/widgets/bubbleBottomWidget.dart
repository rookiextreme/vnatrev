...
import 'package:vnatpro2/app/views/navbar/utils/colors/navbarColors.dart';
...
BubbleBottomBarItem tab(IconData iconData, String tabName) {
  return BubbleBottomBarItem(
      backgroundColor: t2_colorPrimary, icon: Icon(iconData, color: Colors.orangeAccent), activeIcon: Icon(iconData, color: Colors.orangeAccent), title: Text(tabName, style: primaryTextStyle()));
}
