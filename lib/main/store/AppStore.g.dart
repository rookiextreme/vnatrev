...
mixin _$AppStore on AppStoreBase, Store {
  late final _$isGoogleSignedInAtom =
      Atom(name: 'AppStoreBase.isGoogleSignedIn', context: context);
  ...
  late final _$googleUserNameAtom =
      Atom(name: 'AppStoreBase.googleUserName', context: context);
  ...
  late final _$googleUserEmailAtom =
      Atom(name: 'AppStoreBase.googleUserEmail', context: context);
  ...
  late final _$googleUserPhotoUrlAtom =
      Atom(name: 'AppStoreBase.googleUserPhotoUrl', context: context);
  ...
  late final _$setValueGoogleSignInAsyncAction =
      AsyncAction('AppStoreBase.setValueGoogleSignIn', context: context);
  ...
  late final _$setGoogleUserNameAsyncAction =
      AsyncAction('AppStoreBase.setGoogleUserName', context: context);
  ...
  late final _$setGoogleUserEmailAsyncAction =
      AsyncAction('AppStoreBase.setGoogleUserEmail', context: context);
  ...
  late final _$setGoogleUserPhotoUrlAsyncAction =
      AsyncAction('AppStoreBase.setGoogleUserPhotoUrl', context: context);
