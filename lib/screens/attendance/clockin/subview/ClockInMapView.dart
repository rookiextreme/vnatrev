...
class ClockInMapView extends StatelessWidget {
  const ClockInMapView({super.key});
  @override
  Widget build(BuildContext context) {
    ...
    // void checkPolygonEntry() async {
    //   setState(() {
    //     final List<Point> points = <Point>[
    //       Point(y: 3.2289459, x: 101.6519022),
    //       Point(y: 3.2285495, x: 101.6519344),
    //       Point(y: 3.2268678, x: 101.6520524),
    //       Point(y: 3.2268463, x: 101.6538012),
    //       Point(y: 3.2289566, x: 101.6535544),
    //       Point(y: 3.2289459, x: 101.6519022),
    //     ];

    //     final Point point =
    //         Point(x: attModel.longitude ?? 0.00, y: attModel.latitude ?? 0.00);

    //     isInPolygon = Poly.isPointInPolygon(point, points);
    //   });
    // }
    var curModel =
